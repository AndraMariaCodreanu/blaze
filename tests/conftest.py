...
while not automation_folder.endswith('blaze'):
...
def pytest_addoption(parser):
    parser.addoption("--host", required=False,default="https://www.demoblaze.com/")
...
def base_ui():
    from framework.pages import home
    base_ui = home.HomePage()
    return base_ui
